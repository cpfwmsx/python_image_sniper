...
class mn5Image:
    ...
    categoryUrls = ("https://www.mn5.cc/Xgyw/", "https://www.mn5.cc/Tuigirl/", "https://www.mn5.cc/Ugirls/","https://www.mn5.cc/Tgod/","https://www.mn5.cc/TouTiao/",
                    "https://www.mn5.cc/Girlt/","https://www.mn5.cc/Aiyouwu/","https://www.mn5.cc/LEGBABY/","https://www.mn5.cc/Mtcos/","https://www.mn5.cc/MissLeg/",
                    "https://www.mn5.cc/BoLoli/","https://www.mn5.cc/Slady/","https://www.mn5.cc/YouMei/","https://www.mn5.cc/Xiuren/","https://www.mn5.cc/MyGirl/",
                    "https://www.mn5.cc/YouWu/","https://www.mn5.cc/IMiss/","https://www.mn5.cc/MiiTao/","https://www.mn5.cc/Uxing/","https://www.mn5.cc/FeiLin/",
                    "https://www.mn5.cc/MiStar/","https://www.mn5.cc/Tukmo/","https://www.mn5.cc/WingS/","https://www.mn5.cc/LeYuan/","https://www.mn5.cc/Taste/",
                    "https://www.mn5.cc/MFStar/","https://www.mn5.cc/Huayan/","https://www.mn5.cc/DKGirl/","https://www.mn5.cc/Candy/","https://www.mn5.cc/YouMi/",
                    "https://www.mn5.cc/MintYe/","https://www.mn5.cc/Micat/","https://www.mn5.cc/Mtmeng/","https://www.mn5.cc/HuaYang/","https://www.mn5.cc/XingYan/",
        ...
        if "http" in startUrl:
            ...
            for i in range(pageNum, totalPage + 1):
                ...
                for biank in bianks:
                    ...
                    existsAlbum = self.exists_data_album(orgSourceAlbumUrl)
                    if existsAlbum is False:
                        ...
                        albumSort = 1
                        albumState = 0
                        album = (albumName, albumCoverMap, albumDesc, categoryId, orgSourceAlbumUrl, albumTags, albumSort, albumState)
                        albumList.append(album)
                    else:
                        print("指定相册已经存在 %s" % orgSourceAlbumUrl)
                time.sleep(1)
            self.saveAlbumToDb(albumList)
    ...
    def parseAlbumImagesByDb(self, albumId):
        ...
        if albumId is None or albumId <= 0 :
            ...
            albumList = self.selectAlbumByState(albumId=0, albumState=0, start=0, limit=1)
        else:
            print(("爬取指定相册id %d") % albumId)
            albumList = self.selectAlbumByState(albumId=albumId, albumState=0, start=0, limit=5)
        if len(albumList) == 0:
        ...
        for album in albumList:
            ...
            for i in range(1, totalPage + 1):
                ...
                for imageDom in imageDomList:
                    ...
                    imageCategoryId = 9
                    imageState = 0
                    exists = self.exists_data_image_album(albumId=albumId, url=imageOrgUrl)
                    if exists is False:
                        imageDto = (albumId, imageAlt, imageTags, imageOrgUrl, imageThumbNailUrl, imageCategoryId, imageState)
                        imageList.append(imageDto)
                    else:
                        print("exists image like %s" % imageOrgUrl)
                if len(imageList) > 0:
                    self.saveImgToDb(imageList)
                time.sleep(1)
            self.updateAlbumStateByAlbumId(albumId = albumId, albumState = 1)


    # 根据相册状态查询集合
    def selectAlbumByState(self, albumId, albumState, start, limit):
        albumList = []
        ...
        try:
            ...
            sql = ''
            if albumId > 0:
                sql = "select * from store_resource_album where album_id = %d and album_state = %d limit %d, %d" % (albumId, albumState, start, limit)
            else:
                sql = "select * from store_resource_album where album_state = %d limit %d, %d" % (albumState, start, limit)
            # print("sql = %s" % sql)
    ...
    # 将相册保存到数据库表
    def saveAlbumToDb(self, albumList):
        exeCount = 0
        conn = self.get_sqlite_connect()
        try:
            conn.text_factory = str ##!!!
    ...
    # 根据相册id更新相册状态
    def updateAlbumStateByAlbumId(self, albumId, albumState):
        conn = self.get_sqlite_connect()
        try:
            cursor = conn.cursor()
    ...
    def exists_data_image_album(self, url, albumId):
        ets = False
        conn = self.get_sqlite_connect()
        cursor = conn.cursor()
        sql_select = "SELECT image_id \
